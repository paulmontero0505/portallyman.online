...
echo json_encode(['success'=>true,'perfil'=>$perfil,'resumen'=>['incidencias'=>count($incidencias),'sanciones'=>count($sanciones),'propuestas'=>count($propuestas),'reconocimientos_aprobados'=>$aprobados,'charlas'=>$asistenciasCharlas + $tardanzasCharlas,'asistencias_charlas'=>$asistenciasCharlas,'tardanzas_charlas'=>$tardanzasCharlas,'faltas_charlas'=>$faltasCharlas,'capacitaciones'=>count($capacitaciones)],'historial'=>compact('incidencias','sanciones','propuestas','reconocimientos','charlas','capacitaciones')],JSON_UNESCAPED_UNICODE);
