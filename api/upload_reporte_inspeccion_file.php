<?php
/* ═══════════════════════════════════════════════════════════════════════
   ESTIBA_TURNO · Subida de UNA evidencia de la acción correctiva
   ───────────────────────────────────────────────────────────────────────
   Recibe multipart/form-data { file }. Valida (imagen/PDF/Office/video
   < 4 MB), la sube a Google Drive vía Apps Script (subcarpeta "Reportes de
   Inspección") y devuelve los metadatos para que save_accion_correctiva.php
...
// Extensión + MIME real: los dos tienen que coincidir.
...
echo json_encode([
    'success'       => true,   // el archivo no se perdió; la acción se puede guardar igual
    'nombre'        => $nombre,
    'mime'          => $mime,
    'peso_bytes'    => (int)$file['size'],
    'drive_file_id' => null,
